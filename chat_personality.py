...
def personality_status_markdown(chat_id: int) -> str:
    ...
    return (
        ...
        f"{persist}\n\n"
        "📌 **Честно:** тон заметен в **обычном разговоре** со Свином (без «что такое»). "
        "На **«что такое …»** ответ идёт из **Википедии** — факты одни и те же, "
        "без подъёба. Игры и «со ссылками» — отдельно.\n\n"
        "⚙️ Меняет **админ**:\n\n"
