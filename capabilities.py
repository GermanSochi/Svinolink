...
def capabilities_markdown() -> str:
    return (
        ...
        "🔎 **«Свин, что такое …»** / **«как сделать …»** — гуглю сам: "
        "Википедия + сайты, картинка, ответ **без ссылок**\n\n"
        "🔎 **«Свин, найди в интернете …»** — то же\n\n"
        "🔎 **«… со ссылками»** — если нужны источники (до 3 шт.)\n\n"
        "🔗 **Ссылка** + **«Свин, прочитай»** — текст со страницы\n\n"
        "🎞️ Просто **Instagram**-ссылка без слов — пришлю **видео** сам\n\n"
        "📄 **Текст из файла**\n\n"
