...
def capabilities_markdown() -> str:
    return (
        ...
        "📜 **«что писал вчера Tom_Frod»** — с **датой и временем** каждого сообщения\n\n"
        "🕐 **«с 15 до 18 вчера»** — только этот интервал (МСК)\n\n"
        "⏰ **«во сколько вчера Tom сказал …»** — точное время из базы\n\n"
        "📄 **Текст из файла**\n\n"
